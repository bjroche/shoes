...
exports.gethomePara2 = function(wlang) {
switch(wlang) {
    case 'en':
...
exports.gethomePara3 = function(wlang) {
switch(wlang) {
    case 'en':
        return 'At La Bella Scarpa we are constantly striving to improve the service we provide for our global clientele, which includes a full refurbishment service ranging from a full re-sole and re-heel to a simple refinishing of edges and uppers. Over four generations we have acquired an enviable reputation for the most excellent made to order service, enabling our clients to compliment their wardrobe with the vast range of styles we offer for every occasion.';
        break;
    case 'fr':
        return 'French: Welcome to La Bella Scarpa';
        break;
...
exports.gethomePara4 = function(wlang) {
switch(wlang) {
    case 'en':
